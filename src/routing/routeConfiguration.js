...
const SellerPage = loadable(() => import(/* webpackChunkName: "SellerPage" */ '../containers/SellerPage/SellerPage'));
...
const AuctionPage = loadable(() => import(/* webpackChunkName: "AuctionPage" */ '../containers/AuctionPage/AuctionPage'));
const AuctionAdminPage = loadable(() => import(/* webpackChunkName: "AuctionAdminPage" */ '../containers/AuctionAdminPage/AuctionAdminPage'));
...
const routeConfiguration = (layoutConfig, accessControlConfig) => {
  ...
  return [
    ...
    },
    {
      ...
      loadData: pageDataLoadingAPI.SellerPage.loadData,
    },
    ...
    },
    {
      ...
      loadData: pageDataLoadingAPI.AuctionPage?.loadData,
    },
    {
      path: '/auction-admin',
      name: 'AuctionAdminPage',
      auth: true,
      authPage: 'LoginPage',
      component: AuctionAdminPage,
    },
    {
      path: '/inbox',
      name: 'InboxBasePage',
